...
const ALL_MENUS = [1, 2, 3, 4, 5, 10, 11, 12, 13, 21, 22, 23, 31, 40];

const assignments: Record<number, number[]> = {
  [ROLE_IDS.ADMINISTRADOR]: ALL_MENUS,
  [ROLE_IDS.SUPERVISOR_AGRICOLA]: [1, 2, 3, 4, 11, 12, 13, 21, 31],
  [ROLE_IDS.GERENTE_PRODUCTOR]: [1, 2, 3, 4, 5, 11, 12, 13, 21, 22, 23, 31, 40],
  [ROLE_IDS.CALIDAD]: [1, 2, 3, 12, 21, 22],
  [ROLE_IDS.LOGISTICA]: [1, 2, 3, 4, 12, 22, 23, 31],
