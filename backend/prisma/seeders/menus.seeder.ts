...
export async function seedMenus(prisma: PrismaClient) {
  ...
  const padres = [
    ...
    { idMenu: 4, etiqueta: 'Trazabilidad', icono: 'fact_check', orden: 4, idPantalla: null, idMenuPadre: null },
  ...
  const hijos = [
    ...
    // Procesos children
    { idMenu: 20, etiqueta: 'Eventos', icono: 'timeline', orden: 1, idPantalla: 5, idMenuPadre: 3 },
    { idMenu: 21, etiqueta: 'Control de Calidad', icono: 'verified', orden: 2, idPantalla: 6, idMenuPadre: 3 },
    { idMenu: 22, etiqueta: 'Empaque', icono: 'package_2', orden: 3, idPantalla: 7, idMenuPadre: 3 },
    { idMenu: 23, etiqueta: 'Envíos', icono: 'local_shipping', orden: 4, idPantalla: 8, idMenuPadre: 3 },
    // Trazabilidad children
    { idMenu: 30, etiqueta: 'Blockchain', icono: 'link', orden: 1, idPantalla: 9, idMenuPadre: 4 },
    { idMenu: 31, etiqueta: 'Consulta de Lote', icono: 'qr_code_scanner', orden: 2, idPantalla: 10, idMenuPadre: 4 },
